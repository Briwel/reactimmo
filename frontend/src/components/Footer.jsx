      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <span translate="no" className="material-symbols-outlined text-black text-2xl">apartment</span>
        ...
        <div className="border-t border-gray-50 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8">
            {['FB', 'TW', 'IG'].map((social) => (
              <a key={social} href="#" translate="no" className="text-[11px] font-black hover:text-primary transition-colors tracking-tighter">
                {social}
              </a>
            ))}
          </div>
